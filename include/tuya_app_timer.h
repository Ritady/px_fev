...
/**
 * @note Call this function if you need to know the latest time immediately.
 * You can register the time callback function(CALLBACK_TYPE_TIME_SYNC) to get
 * the synchronization result.
 * @param none
 * @return none
 */
extern void dev_time_sync_manual(void);
