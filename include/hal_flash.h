...
/**
 * @note write data to token flash
 * @param[in] {data} data
 * @param[in] {len} data length
 * @return Length of write data
 */
...
/**
 * @note read data from token flash 
 * @param[in] {data} data
 * @param[in] {len} data length
...
/**
 * @note write data to main flash, max size: 8192
 * @param[in] {data} data
 * @param[in] {len} data length
 * @return Length of write data
 */
extern uint16_t main_flash_write(uint8_t IN *data, uint16_t data_len);

/**
 * @note read data to main flash, max size: 8192
 * @param[out] {data} data
 * @param[in] {len} Length of read data
 * @return Length of read data
 */
extern uint16_t main_flash_read(uint8_t OUT *data, uint16_t data_len);

/**
 * @note write data to main flash
 * @param[in] {addr} flash address
 * @param[in] {data} data
 * @param[in] {len} data length
 * @return Length of write data
 */
extern uint16_t raw_flash_write(uint32_t addr, uint8_t IN *data, uint16_t data_len);

/**
 * @note read data from main flash
 * @param[in] {addr} flash address
 * @param[out] {data} data
 * @param[in] {len} Length of read data
 * @return Length of read data
 */
extern uint16_t raw_flash_read(uint32_t addr, uint8_t OUT *data, uint16_t data_len);
