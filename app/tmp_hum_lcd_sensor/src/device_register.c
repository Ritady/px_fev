...
const attr_t temperature_server_attr_list[] = {
    TEMPERATURE_ATTR_LIST
};

/* Humidity attribute */
const attr_t humidity_server_attr_list[] = {
    HUMIDITY_ATTR_LIST
};
...
const cluster_t app_server_cluster_list[] = {
    ...
    DEF_CLUSTER_TEMP_MEASUREMENT_CLUSTER_ID(temperature_server_attr_list)
    DEF_CLUSTER_RELATIVE_HUMIDITY_MEASUREMENT_CLUSTER_ID(humidity_server_attr_list)
};
